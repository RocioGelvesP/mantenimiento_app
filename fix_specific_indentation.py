#!/usr/bin/env python3
"""
Script para corregir el error específico de indentación:
with open('/tmp/hoja_vida_debug.html', 'w', encoding='utf-8') as f:
f.write(html)  # ← Esta línea necesita indentación
"""

import os

def fix_specific_indentation():
    """Corrige el error específico de indentación"""
    ...
    for i, line in enumerate(lines):
        ...
        # Buscar la línea con el with statement específico
        if ("with open('/tmp/hoja_vida_debug.html', 'w', encoding='utf-8') as f:" in line or
            'with open' in line and 'hoja_vida_debug.html' in line):
            ...
            if i + 1 < len(lines):
                ...
                # Si la siguiente línea contiene 'f.write(html)' y no está indentada
    ...
    if fixed:
        ...
        print("No se encontró el patrón específico para corregir")
        return False
...
def main():
    """Función principal"""
    print("=== Corrección del Error Específico de Indentación ===")
